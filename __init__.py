...
def classFactory(iface):  # pylint: disable=invalid-name
    """Load PublicLightingToolbox class from file PublicLightingToolbox.

    :param iface: A QGIS interface instance.
    :type iface: QgsInterface
    """
    #
    from .PublicLightingToolbox import PublicLightingToolboxPlugin
    return PublicLightingToolboxPlugin()
