...
class ControllerConnector():
    ...
    def __init__(self,dlg):
        ...
        self.dlg.mMapLayerComboBoxExtentRadiance.setFilters(QgsMapLayerProxyModel.Filter.PolygonLayer)
        self.dlg.mMapLayerComboBoxImageRadiance.setFilters(QgsMapLayerProxyModel.Filter.RasterLayer)
        ...
        self.dlg.mMapLayerComboBoxExtentBlue.setFilters(QgsMapLayerProxyModel.Filter.PolygonLayer)
        self.dlg.mMapLayerComboBoxImageBlue.setFilters(QgsMapLayerProxyModel.Filter.RasterLayer)
        ...
        self.dlg.mMapLayerComboBoxExtentMNS.setFilters(QgsMapLayerProxyModel.Filter.PolygonLayer)
        self.dlg.mMapLayerComboBoxMNT.setFilters(QgsMapLayerProxyModel.Filter.RasterLayer)
        self.dlg.mMapLayerComboBoxBuildings.setFilters(QgsMapLayerProxyModel.Filter.PolygonLayer)
        self.dlg.mMapLayerComboBoxVegetation.setFilters(QgsMapLayerProxyModel.Filter.PolygonLayer)
        ...
        self.dlg.mMapLayerComboBoxExtentViewshed.setFilters(QgsMapLayerProxyModel.Filter.PolygonLayer)
        self.dlg.mMapLayerComboBoxLightPoints.setFilters(QgsMapLayerProxyModel.Filter.PointLayer)
        self.dlg.mMapLayerComboBoxMNS.setFilters(QgsMapLayerProxyModel.Filter.RasterLayer)
        self.dlg.mMapLayerComboBoxRasterBatiVegeViewshed.setFilters(QgsMapLayerProxyModel.Filter.RasterLayer)
        ...
        self.dlg.mMapLayerComboBoxExtentNbLight.setFilters(QgsMapLayerProxyModel.Filter.PolygonLayer)
        self.dlg.mMapLayerComboBoxViewshedResult.setFilters(QgsMapLayerProxyModel.Filter.RasterLayer)
        self.dlg.mMapLayerComboBoxRasterBatiVege.setFilters(QgsMapLayerProxyModel.Filter.RasterLayer)
